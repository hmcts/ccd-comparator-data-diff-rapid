...
func (factory *RuleFactory) createEnabledRuleList(activeAnalyzeRules string) ([]Rule, error) {
	...
	var ruleConfig = factory.configuration.Scan
	rules := make([]Rule, 0)
...
func (factory *RuleFactory) GetEnabledRuleList() []Rule {
	return factory.enabledRuleList
}
