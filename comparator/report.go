...
func SaveReport(eventDifferences map[string][]EventFieldDifference, analyzeResult *AnalyzeResult, configurations *config.Configurations) ([]EventDataReportEntity, error) {
