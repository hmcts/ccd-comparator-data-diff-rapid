...
func Test_compareNodes(t *testing.T) {
	...
	expectedDifferences := &differences{
		differencesByPath: map[string][]EventFieldDifference{
			".field1": {
				{
					OldRecord:       "123",
					NewRecord:       "456",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			compareNodes(tt.args.base, tt.args.compareWith, tt.args.differences, tt.args.parentPath, tt.args.eventId,
...
func TestGetDifferences(t *testing.T) {
	...
	differences := getDifferences(123, eventDetails)

	expectedDifferences := EventFieldDifferences{
		"123->.field1": {
...
func TestCompareCaseEvents(t *testing.T) {
	...
	expectedResult := EventFieldDifferences{
		"1->.field1": {
			{
				OldRecord:       "value1",
				NewRecord:       "value2",
	...
	result := CompareCaseEvents("", caseEvents)
